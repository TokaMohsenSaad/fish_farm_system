  ...
  return (
    <>
      <div className="back" style={{ marginLeft: '50px', marginTop: '50px' }}>
        ...
        <div style={{ width: '929px', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '10px', backgroundColor: 'white', height: '10px', borderRadius: '5px', border: '1px solid #ccc'  }}>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <div style={{ backgroundColor: '#f7fafc', height: '30px', width: '220px', alignContent: 'center' }}>
              <label style={{ marginRight: '5px', marginLeft: '10px', color: 'gray' }}>Number of rows to display :</label>
            </div>
            <input
              placeholder="Number of rows"
              onChange={handleRowsChange}
              style={{ padding: '5px', borderRadius: '4px', width: '300px', height:"20px", border: 0, borderLeft: '1px solid #ccc' }}
            />
          </div>
          <div style={{ display: 'flex', alignItems: 'center', borderLeft: '1px solid #ccc' }}>
            <div style={{ backgroundColor: '#f7fafc', height: '30px', width: '100px', alignContent: 'center' }}>
              <label style={{ marginRight: '5px', marginLeft: '10px', color: 'gray' }}>Search :</label>
            </div>
            <input
          ...
          {error ? (
            <div className="my-3 justify-content-center">
              <div className="mt-3 mb-0 w-50 text-center ms-3">
                {error}
              </div>
            </div>
          ) : !dataUser.length ? (
                        ...
                        {item.roleID
                          ...
                          : showEmployeeButtons[index] && (
                              <Button
                                ...
                                className=" mx-0 my-2"
                                onClick={() => addEmployee(item.UserID, index)}
                              >
                                {loadEmployee[index] ? (
                                  <>
                                    <Spinner
