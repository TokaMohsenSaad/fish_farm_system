            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'start', alignItems: 'center', marginTop: '60px' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', marginTop: '20px' }}>
                        ...
                        <div style={{ position: 'relative', marginLeft: '10px' }}>
                            <button 
                                ...
                                {selectedTreatment}
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ width: '15px', height: '15px', marginLeft: '50px' }}>
                    ...
                    <div style={{ display: 'flex', marginTop: '20px' }}>
                        ...
                        <div style={{ marginLeft: '10px', marginTop: '7px', display: 'flex' }}>
                    ...
                    <button 
                        ...
                        style={{ marginTop: '20px', padding: '10px', backgroundColor: '#1f639e', color: 'white', border: 'none', borderRadius: '5px' }}>
                        Submit Treatment
                    </button>
                </div>
            </div>
