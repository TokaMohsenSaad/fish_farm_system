...
export default function AddingFish() {
    ...
    return (
        <div style={{ 
            ...
            <input type="text" placeholder="  Fish Name" className='inputname' />
            ...
            >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" style={{ width: '20px', height: '20px', position: 'absolute', left: '1020px' }}>
