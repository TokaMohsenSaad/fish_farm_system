...
export default function AddingForm({ addTank }) {
    ...
    return (
        <div style={{ width: '430px', height: '300px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'start' }}>
            <h1 style={{ color: '#46a2f5', fontWeight: 'normal', marginLeft: '-12%' }}>Adding a Tank Form</h1>
            <input
                type="text"
            ...
            <button
                ...
                className="addtank"
                style={{ textDecoration: 'none', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '10px', marginLeft: '-10%' }}
            >
                <p style={{ textAlign: 'center', fontWeight: 'bold', marginTop: '15px' }}>Done</p>
