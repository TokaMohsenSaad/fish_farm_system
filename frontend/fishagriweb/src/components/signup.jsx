  ...
  const handleSubmit = async () => {
    ...
    if (!validateEmail(email)) {
      setMessage({
        show: true,
        type: "error",
        text: "Invalid email. Please use @gmail.com or @hotmail.com.",
      });
      return;
    }
            ...
            >
              ...
              <div style={{ display: "flex" }}>
                ...
                <div style={{ marginRight: "20px", textAlign: "start" }}>
                  <p
                    style={{ color: "#46a2f5", cursor: "pointer" }}
                    id="firstname"
                    onClick={() => inputRefs.current["firstname"].focus()}
                  >
                    First Name
                  </p>
                  <input
                ...
                <div style={{ textAlign: "start" }}>
                  <p
                    style={{ color: "#46a2f5", cursor: "pointer" }}
                    id="lastname"
                    onClick={() => inputRefs.current["lastname"].focus()}
                  >
                    Last Name
                  </p>
                  <input
              ...
              <div style={{ textAlign: "start" }}>
                <p
                  style={{ color: "#46a2f5", cursor: "pointer" }}
                  id="email"
                  onClick={() => inputRefs.current["email"].focus()}
                >
                  Your email
                </p>
                <input
              ...
              <div>
                <div style={{ display: "flex" }}>
                  <p
                    style={{ color: "#46a2f5", cursor: "pointer" }}
                    id="pass"
                    onClick={() => inputRefs.current["password"].focus()}
                  >
                    Your password
                  </p>
                  <button
